<?php
	...
	define('DB_HOST', get_param('OPENSHIFT_MYSQL_DB_HOST'));
	define('DB_USER', get_param('OPENSHIFT_MYSQL_DB_USERNAME'));
	define('DB_NAME', get_param('OPENSHIFT_APP_NAME'));
	define('DB_PASS', get_param('OPENSHIFT_MYSQL_DB_PASSWORD'));
	define('DB_PORT', get_param('OPENSHIFT_MYSQL_DB_PORT')); // when neeeded, PG-only
	...
	define('SELF_URL_PATH', 'http://' . get_param('OPENSHIFT_APP_DNS') . '/');
	...
	define('LOCK_DIRECTORY', get_param('OPENSHIFT_DATA_DIR') . 'lock');
	// Directory for lockfiles, must be writable to the user you run
	// daemon process or cronjobs under.

	define('CACHE_DIR', get_param('OPENSHIFT_DATA_DIR') . 'cache');
